...
import com.kip.gillz.amigo.Adminpage;
...
public class WebBtask extends AsyncTask<String,Void,String> {
    Context ctx;
    ...
    private void accessgranted() {
        ...
        ( dialog.findViewById(R.id.bt_close)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ctx,Adminpage.class);
