...
public class profbacktask extends AsyncTask<String,Void,String> {
    String upload_url="https://tal.co.ke/tal/individual.php";
    String meternoHolder="meternoHolder";
    ...
    private profadapter adapte;
    List<profmodel> productList;

    public profbacktask(Context ctx){
        this.ctx=ctx;
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setTitle("Loading Selected Client Details");
        ...
        adapte = new profadapter(ctx, productList);
    }
    @Override
            ...
            if (text33.equals("<")) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        productList.add(new profmodel(
                                xxx.getInt("Meterno"),
                                xxx.getString("Date_Scanned"),
                                xxx.getInt("Consumption"),
                                xxx.getInt("Amount")
                                ));
                    }
