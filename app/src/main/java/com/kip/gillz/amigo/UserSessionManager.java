...
public class UserSessionManager {
	...
	private static final String PREFER_UNAME = "User_Login";
	...
	public UserSessionManager(Context context){
		...
		pref = _context.getSharedPreferences(PREFER_UNAME, PRIVATE_MODE);
		editor = pref.edit();
	...
	public HashMap<String, String> getUserDetails(){
		...
		// user email id
		user.put(KEY_ADMIN_PASSWORD, pref.getString(KEY_ADMIN_PASSWORD, null));
